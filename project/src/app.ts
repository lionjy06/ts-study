...
// DOM
const confirmedTotal: HTMLParagraphElement = $(
  '.confirmed-total'
) as HTMLParagraphElement;
const deathsTotal: HTMLParagraphElement = $('.deaths') as HTMLParagraphElement;
const recoveredTotal: HTMLParagraphElement = $(
  '.recovered'
) as HTMLParagraphElement;
const lastUpdatedTime: HTMLParagraphElement = $(
  '.last-updated-time'
) as HTMLParagraphElement;
...
function fetchCountryInfo(countryCode: string, status: Status) {
